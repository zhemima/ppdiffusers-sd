config = {
    "txt2img": {
        "prompt": "The ancient Chinese city has a very dense array of buildings arranged in an orderly fashion from left to right. From near to far, layer by layer\n, sunny day,(Blue sky with white clouds),(wide angle establishing shot),(perspective),detailed render, (pixel art),2d game art,Studio Ghibli,",
        "negative_prompt": '(Isometric),(Top down),lowres, bad anatomy, bad hands, text, error, missing fingers, extra digit, fewer digits, cropped, worst quality, low quality, normal quality, jpeg artifacts, signature, watermark, username, blurry',
        "width": 960,
        "height": 480,
        "seed": -1,
        "num_return_images": 2,
